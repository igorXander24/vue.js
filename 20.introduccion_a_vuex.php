        ...
        Vue.component('context', {
            template: `
                <menu v-if="visibilityContextMenu" v-bind:style="{ top: topMenuLocation, left: leftMenuLocation }">
                    ...
                    <list-color>
                        <color @click="changeBackgroundColor({ color: 'red' })" class="red"></color>
                        <color @click="changeBackgroundColor({ color: 'orange' })" class="orange"></color>
                        <color @click="changeBackgroundColor({ color: 'green' })" class="green"></color>
                        <color @click="changeBackgroundColor({ color: 'blue' })" class="blue"></color>
                        <color @click="changeBackgroundColor({ color: 'gray' })" class="gray"></color>
                        <color @click="changeBackgroundColor({ color: 'pink' })" class="pink"></color>
                        <color @click="changeBackgroundColor({ color: 'yellow' })" class="yellow"></color>
                    </list-color>
                    <comentary>
                        <p>
            ...
            methods: {
                //<- Mapeo de mutaciones
                ...Vuex.mapMutations(['changeBackgroundColor'])
            }
        });
