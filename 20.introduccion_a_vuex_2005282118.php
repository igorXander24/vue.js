...
<body>
    ...
    <script>
        ...
        Vue.component('board', {
            template: `
                <div id="container" class="container" @contextmenu="openMenu" :class="$store.state.backgroundClassBoard" @click="verifyContext">
        ...
        Vue.component('context', {
            template: `
                <menu v-if="$store.state.visibilityContextMenu" v-bind:style="{ top: $store.state.topMenuLocation, left: $store.state.leftMenuLocation }">
